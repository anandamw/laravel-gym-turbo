...
<!-- Mirrored from www.annimexweb.com/items/avone/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Jul 2024 19:09:27 GMT -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Create An Account - Avone Multipurpose eCommerce Bootstrap4 Html Template</title>
                          	...
                          	<div class="row">
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="CustomerFirstName" type="text" name="customer[first-name]" placeholder="" class="" autocorrect="off" autocapitalize="off" autofocus>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="CustomerLastName">Last Name <span class="required">*</span></label>
                                        <input id="CustomerLastName" type="text" name="customer[Last-name]" placeholder="" class="" autocorrect="off" autocapitalize="off" autofocus>                        	
                                    </div>
                                </div>
                          	</div>
                          	<div class="row">
                          		<div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                	<div class="form-group">
                                    	...
                                    	<input id="CustomerEmail" type="email" name="customer[email]" placeholder="" class="" autocorrect="off" autocapitalize="off" autofocus>                        	
                                	</div>
                            	</div>
                          	</div>
                            <div class="row">
