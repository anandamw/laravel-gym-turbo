...
<body class="login-page">
    ...
    <div class="page-wrapper">
        ...
        <div class="notification-bar mobilehide">
            <a href="#" class="notification-bar__message"><b>Mutipurpose E-Commerce</b> PURCHASE THIS INCREDIBLE
                Temaplate
                NOW!</a>
                    ...
                    <div class="col-1 col-sm-1 col-md-1 col-lg-8 align-self-center d-menu-col">
                        ...
                        <nav class="grid__item" id="AccessibleNav">
                            <ul id="siteNav" class="site-nav medium center hidearrow">
                                                ...
                                                <ul class="grid">
                                                    <li class="grid__item lvl-1 col-md-4 col-lg-4">
                                                        ...
                                                        <ul class="subLinks">
                                                            ...
                                                            <li class="lvl-2">
                                                                <a href="index-pottery-store.html"
                                                    ...
                                                    <li class="grid__item lvl-1 col-md-4 col-lg-4">
                                                        ...
                                                        <ul class="subLinks">
                                                            ...
                                                            <li class="lvl-2">
                                                                <a href="index-medical-demo.html"
                                                                    class="site-nav lvl-2">Medical</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="index-demo18.html"
                                                                    class="site-nav lvl-2">Furniture Store
                                                                    <span class="lbl nm_label4">Hot</span></a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="index-christmas-1.html"
                                                                    class="site-nav lvl-2">Christmas 1</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="index-christmas-2.html"
                                                                    class="site-nav lvl-2">Christmas 2</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="index-bags-store.html"
                                                                    class="site-nav lvl-2">Bags Store</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="index-digital-store.html"
                                                                    class="site-nav lvl-2">Digital Store</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="index-beachwear.html"
                                                                    class="site-nav lvl-2">Beachwear</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="index-bike-store.html"
                                                ...
                                                <ul class="grid mm-Banners">
                                                    <li class="grid__item large-up--one-half imageCol">
                                                        <a href="#"><img class="lazyload"
                                                                src="assets/images/megamenu-banner7.jpg"
                                                                data-src="assets/images/megamenu-banner7.jpg"
                                                                alt="" /></a>
                                                    </li>
                                                    <li class="grid__item large-up--one-half imageCol">
                                                        <a href="#"><img class="lazyload"
                                                                src="assets/images/megamenu-banner8.jpg"
                                                                data-src="assets/images/megamenu-banner8.jpg"
                                                                alt="" /></a>
                                                    </li>
                                                </ul>
                                            </li>
                                    ...
                                    <div class="megamenu style4">
                                        <ul class="grid grid--uniform mmWrapper">
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3">
                                                ...
                                                <ul class="subLinks">
                                                    ...
                                                    <li class="lvl-2">
                                                        <a href="category-empty.html" class="site-nav lvl-2">Category
                                                            Empty</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3">
                                                ...
                                                <ul class="subLinks">
                                                    <li class="lvl-2">
                                                        <a href="shop-left-sidebar.html" class="site-nav lvl-2">Simple
                                                            Heading</a>
                                                    </li>
                                                    <li class="lvl-2">
                                                        <a href="shop-small-heading.html" class="site-nav lvl-2">Small
                                                            Heading</a>
                                                    </li>
                                                    <li class="lvl-2">
                                                    ...
                                                    <li class="lvl-2">
                                                        <a href="shop-heading-with-banner2.html"
                                                            class="site-nav lvl-2">Headings With Banner#2</a>
                                                    </li>
                                                    <li class="lvl-2">
                                                        <a href="swatches-style.html" class="site-nav lvl-2">Swatches
                                                            Style</a>
                                                    </li>
                                                    <li class="lvl-2">
                                                        <a href="shop-right-sidebar.html"
                                            ...
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3">
                                                ...
                                                <ul class="subLinks">
                                                    ...
                                                    <li class="lvl-2">
                                                        <a href="cart-style2.html" class="site-nav lvl-2">Cart Page
                                                            Style2</a>
                                                    </li>
                                                    <li class="lvl-2">
                                        ...
                                        <div class="row clear">
                                            <div class="col-md-4 col-lg-4">
                                                <a href="#;"><img src="assets/images/megamenu-banner4.jpg"
                                                        data-src="assets/images/megamenu-banner4.jpg"
                                                        alt="" /></a>
                                            </div>
                                            <div class="col-md-4 col-lg-4">
                                                <a href="#;"><img src="assets/images/megamenu-banner5.jpg"
                                                        data-src="assets/images/megamenu-banner5.jpg"
                                                        alt="" /></a>
                                            </div>
                                            <div class="col-md-4 col-lg-4">
                                                <a href="#;"><img src="assets/images/megamenu-banner6.jpg"
                                                        data-src="assets/images/megamenu-banner6.jpg"
                                                        alt="" /></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="lvl1 parent megamenu">
                                    <a href="#">Features <i class="anm anm-angle-down-l"></i></a>
                                                        ...
                                                        <ul class="subLinks">
                                                            <li class="lvl-2">
                                                                <a href="product-layout1.html"
                                                                    class="site-nav lvl-2">Product Layout1</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="product-layout2.html"
                                                                    class="site-nav lvl-2">Product Layout2</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="product-layout3.html"
                                                                    class="site-nav lvl-2">Product Layout3</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="product-layout4.html"
                                                                    class="site-nav lvl-2">Product Layout4</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="product-layout5.html"
                                                                    class="site-nav lvl-2">Product Layout5</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="product-layout6.html"
                                                                    class="site-nav lvl-2">Product Layout6</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="product-layout7.html"
                                                                    class="site-nav lvl-2">Product Layout7</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="product-accordian.html"
                                                                    class="site-nav lvl-2">Product Accordian</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="product-tabs-left.html"
                                                                    class="site-nav lvl-2">Product Tabs Left</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                        ...
                                                        <ul class="subLinks">
                                                            <li class="lvl-2">
                                                                <a href="product-standard.html"
                                                                    class="site-nav lvl-2">Standard Product</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="product-variable.html"
                                                                    class="site-nav lvl-2">Variable Product</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                            ...
                                                            <li class="lvl-2">
                                                                <a href="product-layout1.html"
                                                                    class="site-nav lvl-2">Variable Image</a>
                                                            </li>
                                                            <li class="lvl-2">
                                                                <a href="product-layout4.html"
                                ...
                                <li class="lvl1 parent dropdown">
                                    ...
                                    <ul class="dropdown">
                                        <li>
                                            <a href="brands-page.html" class="site-nav">Brands Page</a>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <ul class="dropdown">
                                                ...
                                                <li>
                                                    <a href="faqs-style2.html" class="site-nav">FAQs Style2</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a href="cms.html" class="site-nav">CMS</a></li>
                                        <li>
                                            <a href="error-404.html" class="site-nav">Error 404</a>
                                        </li>
                                        <li>
                                ...
                                <li class="lvl1 parent dropdown">
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li>
                                            <a href="blog-single-post.html" class="site-nav">Single Post</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
        ...
        <div class="mobile-nav-wrapper" role="navigation">
            ...
            <ul id="MobileNav" class="mobile-nav">
                <li class="lvl1 parent megamenu">
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="index.html" class="site-nav">Home 01 <span
                                            class="lbl nm_label3">Popular</span></a>
                                </li>
                                <li>
                                    <a href="index-demo2.html" class="site-nav">Home 02 <span
                                            class="lbl nm_label3">Popular</span></a>
                                </li>
                                <li>
                                    <a href="index-demo3.html" class="site-nav">Home 03</a>
                                </li>
                                <li>
                                    <a href="index-demo4.html" class="site-nav">Home 04</a>
                                </li>
                                <li>
                                    <a href="index-demo5.html" class="site-nav">Home 05</a>
                                </li>
                                <li>
                                    <a href="index-demo6.html" class="site-nav">Home 06</a>
                                </li>
                                <li>
                                    <a href="index-demo7.html" class="site-nav">Home 07</a>
                                </li>
                                <li>
                                    <a href="index-demo8.html" class="site-nav">Home 08</a>
                                </li>
                                <li>
                                    <a href="index-demo9.html" class="site-nav">Home 09</a>
                                </li>
                                <li>
                                    <a href="index-pottery-store.html" class="site-nav">Pottery Store</a>
                                </li>
                                <li>
                                    <a href="index-modern.html" class="site-nav">Modern <span
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="index-demo10.html" class="site-nav">Home 10</a>
                                </li>
                                <li>
                                    <a href="index-demo11.html" class="site-nav">Home 11</a>
                                </li>
                                <li>
                                    <a href="index-demo12.html" class="site-nav">Home 12</a>
                                </li>
                                <li>
                                    <a href="index-demo13.html" class="site-nav">Home 13</a>
                                </li>
                                <li>
                                    <a href="index-demo14.html" class="site-nav">Home 14</a>
                                </li>
                                <li>
                                    <a href="index-demo15.html" class="site-nav">Home 15</a>
                                </li>
                                <li>
                                    <a href="index-demo16.html" class="site-nav">Home 16</a>
                                </li>
                                <li>
                                    <a href="index-demo17.html" class="site-nav">Home 17</a>
                                </li>
                                <li>
                                    <a href="index-yoga-shop.html" class="site-nav">Yoga Shop</a>
                                </li>
                                <li>
                                    <a href="index-wine-store.html" class="site-nav">Wine Store</a>
                                </li>
                                <li>
                                    <a href="index-plants.html" class="site-nav">Plants <span
                                            class="lbl nm_label2">New</span></a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li class="lvl-2">
                                    <a href="index-jewelry-store.html" class="site-nav">Jewelry Store</a>
                                </li>
                                <li class="lvl-2">
                                    <a href="index-pet-store.html" class="site-nav">Pet Store <span
                                            class="lbl nm_label4">Hot</span></a>
                                </li>
                                <li class="lvl-2">
                                    <a href="index-medical-demo.html" class="site-nav">Medical</a>
                                </li>
                                <li class="lvl-2">
                                    <a href="index-demo18.html" class="site-nav">Furniture Store <span
                                            class="lbl nm_label4">Hot</span></a>
                                </li>
                                <li class="lvl-2">
                                    <a href="index-christmas-1.html" class="site-nav">Christmas 1</a>
                                </li>
                                <li class="lvl-2">
                                    <a href="index-christmas-2.html" class="site-nav">Christmas 2</a>
                                </li>
                                <li class="lvl-2">
                                    <a href="index-bags-store.html" class="site-nav">Bags Store</a>
                                </li>
                                <li class="lvl-2">
                                    <a href="index-digital-store.html" class="site-nav">Digital Store</a>
                                </li>
                                <li class="lvl-2">
                                    <a href="index-beachwear.html" class="site-nav">Beachwear</a>
                                </li>
                                <li class="lvl-2">
                                    <a href="index-bike-store.html" class="site-nav">Bike Store</a>
                                </li>
                                <li class="lvl-2">
                                    <a href="index-kids-toy.html" class="site-nav lvl-2">Kids Toy <span
                                            class="lbl nm_label2">New</span></a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="category-6columns.html" class="site-nav">6 Columns with Fullwidth</a>
                                </li>
                                <li>
                                    <a href="category-7columns.html" class="site-nav">7 Columns</a>
                                </li>
                                <li>
                                    <a href="category-empty.html" class="site-nav last">Category Empty</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="shop-list-view.html" class="site-nav">List View</a>
                                </li>
                                <li>
                                    <a href="shop-category-slideshow.html" class="site-nav">Category Slideshow</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="shop-fullwidth.html" class="site-nav">Fullwidth/No Sidebar</a>
                                </li>
                                <li>
                                    <a href="shop-no-sidebar.html" class="site-nav">No Sidebar/No Filter</a>
                                </li>
                                <li>
                                    <a href="shop-category-slideshow.html" class="site-nav last">With category
                                        description</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="shop-left-sidebar.html" class="site-nav">Simple Heading</a>
                                </li>
                                <li>
                                    <a href="shop-small-heading.html" class="site-nav">Small Heading</a>
                                </li>
                                <li>
                                    <a href="shop-no-sidebar.html" class="site-nav">Big Heading With Image</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="classic-pagination.html" class="site-nav last">Classic Pagination</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="my-wishlist.html" class="site-nav">My Wishlist</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="compare-style2.html" class="site-nav last">Compare Page Style2</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="lvl1 parent megamenu">
                    ...
                    <ul>
                        <li>
                            <a href="product-layout1.html" class="site-nav">Product Page<i
                        ...
                        <li>
                            <a href="short-description.html" class="site-nav">Product Page Types <i
                                    class="anm anm-plus-l"></i></a>
                            <ul>
                                <li>
                                    <a href="product-standard.html" class="site-nav">Standard Product</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="product-external-affiliate.html" class="site-nav">External / Affiliate
                                        Product</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="product-layout4.html" class="site-nav">Variable Select</a>
                                </li>
                                <li>
                ...
                <li class="lvl1 parent megamenu">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="coming-soon.html" class="site-nav">Coming soon</a>
                        </li>
                    </ul>
                </li>
                <li class="lvl1 parent megamenu">
            ...
            <div class="breadcrumbs-wrapper">
                <div class="container">
                    <div class="breadcrumbs">
                        ...
                        <span aria-hidden="true">|</span> <span>Login</span>
                    </div>
                </div>
            </div>
            <!--End Breadcrumbs-->
        ...
        <div class="footer footer-1">
            ...
            <div class="footer-bottom clearfix">
                <div class="container">
                    ...
                    <div class="copytext">&copy; 2021 Avone. All Rights Reserved.</div>
                </div>
            </div>
        </div>
        <!--End Footer-->
                ...
                <div class="modal-content">
                    <div id="cart-drawer" class="block block-cart">
                            ...
                            <ul class="clearfix">
                                <li class="item clearfix">
                                    <a class="product-image" href="#">
                                        <img src="assets/images/product-images/cart-page-img2.jpg" alt=""
                                            title="" />
                                    </a>
                                ...
                                <li class="item clearfix">
                                    <a class="product-image" href="#">
                                        <img src="assets/images/product-images/cart-page-img1.jpg" alt=""
                                            title="" />
                                    </a>
                                    <div class="product-details">
                                        <a href="#" class="remove"><i class="anm anm-times-sql"
                        ...
                        <div class="minicart-bottom">
                            ...
                            <button type="button" class="btn proceed-to-checkout">
                                Proceed to Checkout
                            </button>
                            <button type="button" class="btn btn-secondary cart-btn">
                                View Cart
                            </button>
                        </div>
                    </div>
