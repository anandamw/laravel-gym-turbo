        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card overflow-hidden">
                <div class="card-header align-items-start border-0 pb-0">
                    <div class="me-auto">
                        <p class="mb-2 fs-13"><i class="fa fa-caret-up scale5 me-2 text-success" aria-hidden="true"></i>4%(30
                            days)</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <a href="javascript:void(0);" class="btn btn-primary light btn-rounded"><i
                                        class="las la-download scale5 me-2"></i>Get Report</a>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header d-sm-flex d-block pb-0 border-0">
                            ...
                            <select class="form-control custom-image-select-1 image-select mt-3 mt-sm-0">
                                <option data-thumbnail="{{ asset('') }}assets/images/svg/eth.svg">
                                    23,511 ETH</option>
                                <option data-thumbnail="{{ asset('') }}assets/images/svg/lit3.svg">
                                    345,455 ETH</option>
                                <option data-thumbnail="{{ asset('') }}assets/images/svg/btc.svg">
                                    789,123 ETH</option>
                            </select>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
                                <div class="items">
                                    <div class="text-center">
                                        <img class="mb-3 rounded" src="{{ asset('') }}assets/images/contacts/1.jpg"
                                            alt="">
                                ...
                                <div class="items">
                                    <div class="text-center">
                                        <img class="mb-3 rounded" src="{{ asset('') }}assets/images/contacts/2.jpg"
                                            alt="">
                                ...
                                <div class="items">
                                    <div class="text-center">
                                        <img class="mb-3 rounded" src="{{ asset('') }}assets/images/contacts/3.jpg"
                                            alt="">
                                ...
                                <div class="items">
                                    <div class="text-center">
                                        <img class="mb-3 rounded" src="{{ asset('') }}assets/images/contacts/4.jpg"
                                            alt="">
                                ...
                                <div class="items">
                                    <div class="text-center">
                                        <img class="mb-3 rounded" src="{{ asset('') }}assets/images/contacts/5.jpg"
                                            alt="">
                            ...
                            <a href="javascript:(0);" class="btn btn-primary d-block btn-lg text-uppercase">Send
                                Money</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3">
                            <select class="form-control custom-image-select-2 image-select mt-3 mt-sm-0">
                                <option data-thumbnail="{{ asset('') }}assets/images/svg/coin.svg">
                                    Dash Coin</option>
                                <option data-thumbnail="{{ asset('') }}assets/images/svg/btc.svg">
                                    Ripple</option>
                                <option data-thumbnail="{{ asset('') }}assets/images/svg/eth.svg">
                        ...
                        <div class="card-footer border-0 pt-0 text-center">
                            <a href="coin-details.html" class="btn-link">Show more <i
                                    class="fa fa-caret-right ms-2 scale-2"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
