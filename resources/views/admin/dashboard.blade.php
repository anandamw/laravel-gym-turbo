                            ...
                            <div class="card-body">
                                ...
                                <div class="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
                                    <div class="items">
                                        <div class="text-center">
                                            <img class="mb-3 rounded"
                                                src="{{ asset('') }}assets/images/contacts/1.jpg" alt="">
                                    ...
                                    <div class="items">
                                        <div class="text-center">
                                            <img class="mb-3 rounded"
                                                src="{{ asset('') }}assets/images/contacts/2.jpg" alt="">
                                    ...
                                    <div class="items">
                                        <div class="text-center">
                                            <img class="mb-3 rounded"
                                                src="{{ asset('') }}assets/images/contacts/3.jpg" alt="">
                                    ...
                                    <div class="items">
                                        <div class="text-center">
                                            <img class="mb-3 rounded"
                                                src="{{ asset('') }}assets/images/contacts/4.jpg" alt="">
                                    ...
                                    <div class="items">
                                        <div class="text-center">
                                            <img class="mb-3 rounded"
                                                src="{{ asset('') }}assets/images/contacts/5.jpg" alt="">
